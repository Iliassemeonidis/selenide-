...
//            $(byXpath("//*[@id=\"changing\"]")).setValue("141");// registrationNumber
//        }
//
//        /*else {
...
//        $(byText("Искать")).click();
//        sleep(10000);
//        boolean regNumbr = $(byText("141")).isDisplayed();//registrationNumber
//        if (regNumbr) {
//            $$(byText("141"))//registrationNumber
//                    .first()
//                    .click();
//
//        }else {
...
//        // заполняем обязательные поля
//        Buttons.requisites();
//        RequiredFields.addressee1(AUTOTEST_NAME1, "Департамент 1");
