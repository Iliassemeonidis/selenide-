...
////        $(byXpath("//*[@id=\"organizationId\"]")).setValue("ЛЕН");
////    }
////    @Test
...
////        $("div.input-select-container:nth-child(3) > div:nth-child(1)").click();
////    }
////@Test
...
////        // подписант нажимаем кнопку и проваливаемся в окно где выбираем подписанта
////        Buttons.save();
////sleep(1000);
////        $("div.form-item-container:nth-child(21) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > button:nth-child(1)").click();
////    }
////    @Test
